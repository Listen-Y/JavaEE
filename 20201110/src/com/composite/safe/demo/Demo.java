package com.composite.safe.demo;


import com.composite.safe.model.Branches;
import com.composite.safe.model.Leaf;
...
public class Demo {
    ...
    public static void main(String[] args) {
        Branches sust = new Branches("陕科大");
        Branches sustTeach = new Branches("陕科大教务组");
        sust.add(sustTeach);
        Branches sust2 = new Branches("陕科大镐京学院");
        sust.add(sust2);
        ...
        Branches sust2Teach = new Branches("陕科大镐京学院教务组");
