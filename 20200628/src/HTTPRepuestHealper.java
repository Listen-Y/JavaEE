...
// 表示一个 HTTP 请求, 并负责解析.
public class HTTPRepuestHealper {
    ...
    // 这个过程本质上就是在 "反序列化"
    public static HTTPRepuestHealper build(InputStream inputStream) throws IOException {
        HTTPRepuestHealper request = new HTTPRepuestHealper();
