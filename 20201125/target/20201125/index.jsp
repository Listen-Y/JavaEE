...
<div class="log">
    <div class="am-g">
        <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
            ...
            <br>
            <form class="am-form" id="log-form" action="">
                ...
                <br>
                <button type="submit" class="am-btn am-btn-primary am-btn-block am-btn-lg am-radius am-animation-slide-bottom log-animation-delay" onclick="login()">登 录</button>
            </form>
        </div>
    </div>
</div>
